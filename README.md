This is project that uses [opensource coincap api’s](https://api.coincap.io/v2/assets) to fetch the list of cryptocurrencies and render them in a table like the original website.
